...
- __Application__ refers to Lotko, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to web-ddd.
...
- __Website__ refers to web-ddd, accessible from [web-ddd.com](web-ddd.com)
